/*
 * A200977: least k having exactly n positive-integer solutions of
 *
 *                    x^2 + 2 y^2 = k.
 *
 ...
 *
 * Build:
 *   clang -O3 -std=c11 -Wall -Wextra -Wpedantic 200977_01.c \
 *       -o 200977_01 $(pkg-config --cflags --libs gmp)
 *
 * Examples:
 *   ./200977_01 --target 23 --verbose
 *   ./200977_01 --upto 100
 *   ./200977_01 --self-test 1000000
 */
...
#define BFILE_NAME "b200977.txt"
#define BFILE_TEMP_NAME "b200977.txt.tmp"
...
{
    unsigned count = 0;
    for (uint64_t p = 3; count < MAX_FACTORS; p += 2)
