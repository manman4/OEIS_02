...
| 6 | [A399870](https://oeis.org/A399870) | [A399871](https://oeis.org/A399871) | [A208775](https://oeis.org/A208775) | [A399872](https://oeis.org/A399872) |
...
OEIS で $`S_q`$、$`L_q`$、$`C_q`$ の3系列すべてに専用項目を確認できる非自明な色数は $`q=3,4,5,6,7`$ である。$`N_q(n)`$ は一般に [A208777](https://oeis.org/A208777) の第 $`q`$ 列である。$`q\ge8`$ についても一般公式は成立するが、対応する専用の $`S_q`$、$`L_q`$、$`C_q`$ の項目は確認できない。
